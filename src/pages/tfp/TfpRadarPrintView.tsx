...
import type { TfpRadarRecordDetail, TfpRadarItem, TfpRadarFacility } from '@/types/tfpRadar';
...
const isModeRow = (item: TfpRadarItem): boolean => item.parameter_name.toLowerCase().startsWith('mode');
const isSuplaiRow = (item: TfpRadarItem): boolean => item.parameter_name.toLowerCase().startsWith('suplai aktif');
...
const renderPrintCell = (item: TfpRadarItem, colKey: ItemColKey): React.ReactElement => {
...
export const TfpRadarPrintView: React.FC = () => {
  ...
  const padded: { item: TfpRadarItem | null; facility: TfpRadarFacility | null }[] = [];
      ...
      <div className="mx-auto max-w-[290mm] bg-white font-sans text-[10px] print:mx-0 print:w-full print:max-w-none">
        ...
        <div className="grid grid-cols-[40%_30%_30%] items-center mb-2 px-2 pt-3">
          ...
          <div className="text-center">
            <div className="text-[13px] font-black leading-tight">Performance Check Gedung Radar</div>
          </div>
